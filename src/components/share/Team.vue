...
<div class="p-8 bg-white justify-center items-center container dark:bg-gray-800 rounded-lg shadow">
    ...
    <div class="flex items-center justify-center mx-auto container flex-col md:flex-row justify evenly">
        <div class="p-4">
