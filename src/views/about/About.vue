<template>
  <div class="about">
    ...
    <section class="bg-gray-900 py-8 " :class="[$route.name == 'Home' ? 'bg-gray-900 py-8 border-t-2 border-yellow-700' : '']">
      <div class="container py-8 px-6 mx-auto">
        ...
        <p class="my-8 text-gray-400">
          ...
          commodo viverra maecenas accumsan lacus vel facilisis volutpat. Vitae
