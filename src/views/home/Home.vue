<template>
  <div class="home bg-gray-800">
    ...
    <!-- Componentlere ayır -->
    <div class="border-t-2 w-full border-yellow-700"></div>
    <div
      class="
        max-w-screen-xl
        p-4
      ...
      <div class="relative">
        ...
        >
          <div class="lg:col-start-2 lg:max-w-2xl ml-auto">
            <p class="text-2xl leading-6 font-bold text-yellow-700">
              Ürünlerimiz
            </p>
            <h4
              class="
            ...
            <p class="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Exercitationem officiis optio, voluptatem dolore reiciendis
              consequuntur laudantium aperiam autem sunt libero aliquam sapiente
              voluptas dolorem minus.
            </p>
